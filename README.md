...
- Washing Machines:
    ...
    - 🫤 F3L7CYK5W_US_WIFI, Front-Load Washing Machine - preliminary support (cycle state, course, timers
      and door confirmed from real cycles; option bits not yet mapped)
- Dryers:
